...
namespace App\Infrastructure\Kernal;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Domain\Middleware\Localization::class,
        ],
    ...
    protected $middlewareAliases = [
        ...
        'permission' => \App\Domain\Middleware\CheckPermission::class,
        'localization' =>  \App\Domain\Middleware\Localization::class,
    ];
}
